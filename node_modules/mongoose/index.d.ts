declare module 'mongoose' {
  ...
  export function connect(uri: string | undefine, options: ConnectOptions, callback: CallbackWithoutResult): void;
  export function connect(uri: string | undefine, callback: CallbackWithoutResult): void;
  export function connect(uri: string | undefine, options?: ConnectOptions): Promise<Mongoose>;
